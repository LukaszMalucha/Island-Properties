...
dataset_old = pd.read_csv("ballincollig_full_offers_old.csv", encoding="utf-8")
dataset_old_2 = pd.read_csv("ballincollig_offers_2021.csv", encoding="utf-8")
dataset_old_2 = dataset_old_2.drop("geocode", axis=1)


dataset_old = pd.concat([dataset_old, dataset_old_2])


dataset_old = dataset_old.drop_duplicates()
