...
dataset = pd.read_csv("ballincollig_actual.csv", encoding="utf-8")


dataset["price"] = dataset["price"].str.replace(",", "").str.replace("\€", "")

dataset = dataset[dataset["address"].notnull()]
dataset = dataset[~dataset["property_type"].str.contains(" Acre ")]
...
dataset["area"] = np.where(dataset["address"].str.contains("Caisleé"), "An Caislean",  dataset["area"] )
dataset["area"] = np.where(dataset["address"].str.contains("Leo Murphy Terrace"), "Town Center",  dataset["area"] )
dataset["area"] = np.where(dataset["address"].str.contains("Carriganarra"), "Carriganarra",  dataset["area"] )
dataset["area"] = np.where(dataset["address"].str.contains("Beech Park"), "Beech Park",  dataset["area"] )
...
dataset["area"] = np.where(dataset["address"].str.contains("Willowcourt"), "Willow Court",  dataset["area"] )
dataset["area"] = np.where(dataset["address"].str.contains("Carrigrohane"), "Carrigrohane",  dataset["area"] )
dataset["area"] = np.where(dataset["address"].str.contains("Shalamir Court"), "Shalimar Court",  dataset["area"] )
dataset["area"] = np.where(dataset["address"].str.contains("Baker"), "Town Center",  dataset["area"] )
dataset["area"] = np.where(dataset["address"].str.contains("Castle Road"), "Castle Road",  dataset["area"] )
...
dataset["geocode"] = np.where(dataset["area"] == "Castle Road", "51.88234227885883, -8.598250759204856",  dataset["geocode"] )
dataset["geocode"] = np.where(dataset["area"] == "Willow Court", "51.89303295971821, -8.580903401534059",  dataset["geocode"] )
...
dataset = dataset[~dataset["address"].str.contains("Berrings")]
dataset = dataset[~dataset["address"].str.contains("Kilnaglory")]
...
dataset.to_csv("ballincollig_offers_2019.csv", index=False)
