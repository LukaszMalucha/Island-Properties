...
dataset_sale = pd.read_csv("islands.csv", encoding="utf-8")
dataset_rent = pd.read_csv("islands_rent.csv", encoding="utf-8")
...
dataset_sale["locality"] = dataset_sale["locality"].str.replace("Santa Maria de Guia de Gran Canaria",
                                                                "Santa Maria de Guia")
dataset_sale["locality"] = dataset_sale["locality"].str.replace("Valsequillo (Telde)", "Valsequillo de Gran Canaria")
dataset_sale["locality"] = dataset_sale["locality"].str.replace("Sa Coma (Cala Millor)", "Sa Coma")
dataset_sale["locality"] = dataset_sale["locality"].str.replace("San Bartolomé de Tirajana",
...
dataset_rent["locality"] = dataset_rent["locality"].str.replace("Santa Maria de Guia de Gran Canaria",
                                                                "Santa Maria de Guia")
dataset_rent["locality"] = dataset_rent["locality"].str.replace("Valsequillo (Telde)", "Valsequillo de Gran Canaria")
dataset_rent["locality"] = dataset_rent["locality"].str.replace("Sa Coma (Cala Millor)", "Sa Coma")
dataset_rent["locality"] = dataset_rent["locality"].str.replace("San Bartolomé de Tirajana",
                                                                "San Bartolome de Tirajana")
...
dataset_sale.to_csv("islands.csv", index=False)
dataset_rent.to_csv("islands_rent.csv", index=False)
