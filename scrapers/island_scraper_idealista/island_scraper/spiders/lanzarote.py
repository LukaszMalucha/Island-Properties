...
class LanzaroteSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        self.driver.get(
            "https://www.idealista.com/en/venta-viviendas/las-palmas/lanzarote/con-precio-hasta_200000,metros-cuadrados-mas-de_40,pisos,de-dos-dormitorios,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas/")
        sleep(2)
        ...
        for page in range(pages_count):
            ...
            self.driver.set_window_size(randrange(1100, 1200), randrange(800, 900))
            self.driver.get(
                f"https://www.idealista.com/en/venta-viviendas/las-palmas/lanzarote/con-precio-hasta_200000,metros-cuadrados-mas-de_40,pisos,de-dos-dormitorios,de-tres-dormitorios,de-cuatro-cinco-habitaciones-o-mas/pagina-{page}.htm")
            sleep(1)
            body = self.driver.find_element_by_css_selector('body')
            sleep(1)
